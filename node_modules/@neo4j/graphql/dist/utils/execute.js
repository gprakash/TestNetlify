...
function execute(input) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const userAgent = `${environment_1.default.NPM_PACKAGE_NAME}/${environment_1.default.NPM_PACKAGE_VERSION}`;
        // @ts-ignore: below
        if ((_a = input.context.driver) === null || _a === void 0 ? void 0 : _a._config) {
        ...
        try {
            ...
            const result = yield session[`${input.defaultAccessMode.toLowerCase()}Transaction`]((tx) => tx.run(cypher, input.params));
