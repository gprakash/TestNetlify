...
describe("checkNeo4jCompat", () => {
    test("should add driver config to session", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(verify_database_1.default({ driver: fakeDriver, driverConfig })).resolves.not.toThrow();
    }));
    test("should throw expected Neo4j version", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(verify_database_1.default({ driver: fakeDriver })).rejects.toThrow(`Encountered the following DBMS compatiblility issues:\nExpected minimum Neo4j version: '${constants_1.MIN_NEO4J_VERSION}' received: '${invalidVersion}'`);
    }));
    test("should not throw Error that 4.1.10 is less than 4.1.5", () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        const fakeSession = {
            // @ts-ignore
            run: () => ({
        ...
        yield expect(verify_database_1.default({ driver: fakeDriver })).resolves.not.toThrow();
    }));
    test("should not throw Error for Aura version numbers", () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        const fakeSession = {
            // @ts-ignore
            run: () => ({
    ...
    test("should throw expected APOC version", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(verify_database_1.default({ driver: fakeDriver })).rejects.toThrow(`Encountered the following DBMS compatiblility issues:\nExpected minimum APOC version: '${constants_1.MIN_APOC_VERSION}' received: '${invalidApocVersion}'`);
    }));
    test("should throw missing APOC functions", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(verify_database_1.default({ driver: fakeDriver })).rejects.toThrow(`Encountered the following DBMS compatiblility issues:\nMissing APOC functions: [ ${constants_1.REQUIRED_APOC_FUNCTIONS.join(", ")} ]`);
    }));
    test("should throw missing APOC procedures", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(verify_database_1.default({ driver: fakeDriver })).rejects.toThrow(`Encountered the following DBMS compatiblility issues:\nMissing APOC procedures: [ ${constants_1.REQUIRED_APOC_PROCEDURES.join(", ")} ]`);
    }));
