    ...
    function reducer(res, [key, value]) {
        ...
        if (key.endsWith("Aggregate")) {
            ...
            if (aggregateWhereAndParams[0]) {
                ...
                res.params = Object.assign(Object.assign({}, res.params), aggregateWhereAndParams[1]);
            }
            return res;
        }
        if (key.endsWith("_NOT")) {
            ...
            if (connectionField) {
                const refNode = context.neoSchema.nodes.find((x) => x.name === connectionField.relationship.typeMeta.name);
                ...
                resultStr += ")"; // close ALL
                res.clauses.push(resultStr);
                res.params = Object.assign(Object.assign({}, res.params), (recursing
                    ? {
        ...
        if (equalityConnection) {
            const refNode = context.neoSchema.nodes.find((x) => x.name === equalityConnection.relationship.typeMeta.name);
