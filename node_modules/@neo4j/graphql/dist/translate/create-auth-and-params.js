...
function createAuthPredicate({ rule, node, varName, context, chainStr, kind, }) {
    ...
    const result = Object.entries(rule[kind]).reduce((res, [key, value]) => {
        ...
        if (authableField) {
            const [, jwtPath] = ((_b = (_a = value) === null || _a === void 0 ? void 0 : _a.split) === null || _b === void 0 ? void 0 : _b.call(_a, "$jwt.")) || [];
            const [, ctxPath] = ((_d = (_c = value) === null || _c === void 0 ? void 0 : _c.split) === null || _d === void 0 ? void 0 : _d.call(_c, "$context.")) || [];
