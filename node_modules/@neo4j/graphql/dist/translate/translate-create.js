...
function translateCreate({ context, node }) {
    ...
    const { fieldsByTypeName } = Object.values(resolveTree.fieldsByTypeName[`Create${node.getPlural({ camelCase: false })}MutationResponse`]).find((field) => field.name === node.getPlural({ camelCase: true }));
    ...
    if ((_d = (_c = projection[2]) === null || _c === void 0 ? void 0 : _c.connectionFields) === null || _d === void 0 ? void 0 : _d.length) {
        projection[2].connectionFields.forEach((connectionResolveTree) => {
            ...
            if (!connectionParams)
                connectionParams = {};
            connectionParams = Object.assign(Object.assign({}, connectionParams), connection[1]);
        });
    }
    ...
    const replacedConnectionParams = connectionParams
        ? createStrs.reduce((res1, _, i) => {
            return Object.assign(Object.assign({}, res1), Object.entries(connectionParams).reduce((res2, [key, value]) => {
                return Object.assign(Object.assign({}, res2), { [key.replace("REPLACE_ME", `this${i}`)]: value });
            }, {}));
        }, {})
        : {};
    ...
    return [cypher.filter(Boolean).join("\n"), Object.assign(Object.assign(Object.assign({}, params), replacedProjectionParams), replacedConnectionParams)];
}
