...
function translateAggregate({ node, context }) {
    const whereInput = context.resolveTree.args.where;
    ...
    Object.entries(selections).forEach((selection) => {
        ...
        if (field) {
            ...
            Object.entries(selection[1].fieldsByTypeName[`${field.typeMeta.name}AggregateSelection`]).forEach((entry) => {
                ...
                if (isDateTime) {
                    thisProjections.push(create_datetime_element_1.default({
                        resolveTree: entry[1],
                        field: field,
                        variable: varName,
