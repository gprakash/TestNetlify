...
function createDisconnectAndParams({ withVars, value, varName, relationField, parentVar, refNode, context, labelOverride, parentNode, insideDoWhen, parameterPrefix, }) {
    function reducer(res, disconnect, index) {
        ...
        if (disconnect.where) {
            const whereAndParams = create_connection_where_and_params_1.default({
