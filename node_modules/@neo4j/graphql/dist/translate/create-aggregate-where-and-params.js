...
function aggregate({ inputValue, nodeOrRelationship, chainStr, variable, }) {
    ...
    Object.entries(inputValue).forEach(([key, value]) => {
        if (["AND", "OR"].includes(key)) {
            ...
            value.forEach((v, i) => {
                ...
                if (recurse.aggregations.length) {
                    ...
                    params = Object.assign(Object.assign({}, params), recurse.params);
                }
        ...
        const field = [...nodeOrRelationship.primitiveFields, ...nodeOrRelationship.temporalFields].find((field) => logicalOperators.some((op) => key.split(`_${op}`)[0] === field.fieldName ||
...
function createPredicate({ node, aggregation, context, chainStr, field, varName, nodeVariable, edgeVariable, relationship, }) {
    const aggregations = [];
    let withStrs = [];
    let params = {};
    Object.entries(aggregation).forEach(([key, value]) => {
        ...
        ["node", "edge"].forEach((nOrE) => {
            ...
            if (aggregation.aggregations.length) {
                ...
                params = Object.assign(Object.assign({}, params), aggregation.params);
            }
