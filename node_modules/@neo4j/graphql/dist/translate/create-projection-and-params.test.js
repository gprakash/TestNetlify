...
describe("createProjectionAndParams", () => {
    test("should be a function", () => {
        expect(create_projection_and_params_1.default).toBeInstanceOf(Function);
    });
    test("should return the correct projection with 1 selection", () => {
        ...
        const result = create_projection_and_params_1.default({ fieldsByTypeName, node, context, varName: "this" });
        expect(result[0]).toEqual(`{ .title }`);
        expect(result[1]).toMatchObject({});
    });
});
//# sourceMappingURL=create-projection-and-params.test.js.map