...
function createDatetimeElement({ resolveTree, field, variable, valueOverride, }) {
    ...
    return field.typeMeta.array
        ...
        : `${resolveTree.alias}: apoc.date.convertFormat(toString(${valueOverride || `${variable}.${dbFieldName}`}), "iso_zoned_date_time", "iso_offset_date_time")`;
}
exports.default = createDatetimeElement;
