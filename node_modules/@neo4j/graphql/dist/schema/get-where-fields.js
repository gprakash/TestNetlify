...
function getWhereFields({ typeName, fields, enableRegex, }) {
    return Object.assign(Object.assign({ OR: `[${typeName}Where!]`, AND: `[${typeName}Where!]` }, fields.scalarFields.reduce((res, f) => {
        res[f.fieldName] = f.typeMeta.array ? `[${f.typeMeta.name}]` : f.typeMeta.name;
        return res;
    }, {})), [...fields.primitiveFields, ...fields.temporalFields, ...fields.enumFields, ...fields.pointFields].reduce((res, f) => {
