...
function filterDocument(document) {
    ...
    const filterFields = (fields) => {
        return fields === null || fields === void 0 ? void 0 : fields.filter((f) => {
            ...
            if ((_a = match === null || match === void 0 ? void 0 : match.groups) === null || _a === void 0 ? void 0 : _a.nodeName) {
                if (nodeNames.map((nodeName) => pluralize_1.default(nodeName)).includes(match.groups.nodeName)) {
                    return false;
                }
            }
            return true;
            ...
            var _a;
            return (Object.assign(Object.assign({}, f), { arguments: filterInputTypes(f.arguments), directives: (_a = f.directives) === null || _a === void 0 ? void 0 : _a.filter((x) => !["auth"].includes(x.name.value)) }));
        });
    };
    return Object.assign(Object.assign({}, document), { definitions: document.definitions.reduce((res, def) => {
            ...
            if (def.kind === "InputObjectTypeDefinition") {
                ...
                return [
                    ...res,
                    Object.assign(Object.assign({}, def), { fields }),
                ];
            }
            if (def.kind === "ObjectTypeDefinition" || def.kind === "InterfaceTypeDefinition") {
                ...
                return [
                    ...res,
                    Object.assign(Object.assign({}, def), { directives: (_a = def.directives) === null || _a === void 0 ? void 0 : _a.filter((x) => !["auth"].includes(x.name.value)), fields }),
                ];
            }
            return [...res, def];
        }, []) });
...
function validateDocument(document) {
    ...
    const schema = graphql_1.extendSchema(schemaToExtend, doc);
    const errors = graphql_1.validateSchema(schema);
