...
const validate_document_1 = __importDefault(require("./validate-document"));
describe("validateDocument", () => {
    test("should throw an error if a directive is in the wrong location", () => {
        ...
        `);
        expect(() => validate_document_1.default(doc)).toThrow('Directive "@coalesce" may not be used on OBJECT.');
    });
    test("should throw an error if a directive is missing an argument", () => {
        ...
        `);
        expect(() => validate_document_1.default(doc)).toThrow('Directive "@coalesce" argument "value" of type "Scalar!" is required, but it was not provided.');
    });
    test("should throw a missing scalar error", () => {
        ...
        `);
        expect(() => validate_document_1.default(doc)).toThrow('Unknown type "Unknown".');
    });
    test("should throw an error if a user tries to pass in their own Point definition", () => {
        ...
        `);
        expect(() => validate_document_1.default(doc)).toThrow('Type "Point" already exists in the schema. It cannot also be defined in this type definition.');
    });
    test("should throw an error if a user tries to pass in their own DateTime definition", () => {
        ...
        `);
        expect(() => validate_document_1.default(doc)).toThrow('Type "DateTime" already exists in the schema. It cannot also be defined in this type definition.');
    });
    test("should throw an error if a user tries to pass in their own PointInput definition", () => {
        ...
        `);
        expect(() => validate_document_1.default(doc)).toThrow('Type "PointInput" already exists in the schema. It cannot also be defined in this type definition.');
    });
    test("should throw an error if an interface is incorrectly implemented", () => {
        ...
        `);
        expect(() => validate_document_1.default(doc)).toThrow("Interface field UserInterface.age expected but User does not provide it.");
    });
    test("should throw an error a user tries to redefine one of our directives", () => {
        ...
        `);
        expect(() => validate_document_1.default(doc)).toThrow('Directive "@relationship" already exists in the schema. It cannot be redefined.');
    });
    test("should remove auth directive and pass validation", () => {
        ...
        `);
        const res = validate_document_1.default(doc);
    ...
    describe("relationshipProperties directive", () => {
        ...
        test("should throw if used on an object type", () => {
            ...
            `);
            expect(() => validate_document_1.default(doc)).toThrow('Directive "@relationshipProperties" may not be used on OBJECT.');
        });
        test("should throw if used on a field", () => {
            ...
            `);
            expect(() => validate_document_1.default(doc)).toThrow('Directive "@relationshipProperties" may not be used on FIELD_DEFINITION.');
        });
    });
    ...
    describe("@alias directive", () => {
        test("should throw an error if missing an argument", () => {
            ...
            `);
            expect(() => validate_document_1.default(doc)).toThrow('Directive "@alias" argument "property" of type "String!" is required, but it was not provided.');
        });
        test("should throw an error if a directive is in the wrong location", () => {
            const doc = graphql_1.parse(`
                type User @alias {
            ...
            `);
            expect(() => validate_document_1.default(doc)).toThrow('Directive "@alias" may not be used on OBJECT.');
        });
...
//# sourceMappingURL=validate-document.test.js.map