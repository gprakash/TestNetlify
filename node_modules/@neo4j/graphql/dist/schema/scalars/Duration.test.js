...
describe("Duration Scalar", () => {
    test.each([42, () => 5, { a: 3, b: 4 }, null, undefined])("should not match %p and throw error", (value) => expect(() => Duration_1.parseDuration(value)).toThrow(TypeError));
    test.each([
        "P",
        "PT",
        "P233WT4H",
        ...
        "P18871104T12:00:00",
        "P1887-11-04T120000",
    ])("should not match %s and throw error", (value) => expect(() => Duration_1.parseDuration(value)).toThrow(TypeError));
    test.each([
    ...
    ])("should match and parse %s correctly", (duration, parsed) => expect(Duration_1.parseDuration(duration)).toStrictEqual(parsed));
});
