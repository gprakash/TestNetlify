...
function cypherResolver({ field, statement, type, }) {
    function resolve(_root, args, _context) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isEnum = context.neoSchema.document.definitions.find((x) => x.kind === "EnumTypeDefinition" && x.name.value === field.typeMeta.name);
            const isScalar = context.neoSchema.document.definitions.find((x) => x.kind === "ScalarTypeDefinition" && x.name.value === field.typeMeta.name);
            ...
            if (referenceNode) {
                ...
                projectionStr = str;
                params = Object.assign(Object.assign({}, params), p);
                ...
                if ((_b = meta === null || meta === void 0 ? void 0 : meta.connectionFields) === null || _b === void 0 ? void 0 : _b.length) {
                    meta.connectionFields.forEach((connectionResolveTree) => {
                        ...
                        const nestedConnection = create_connection_and_params_1.default({
