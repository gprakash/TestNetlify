...
function updateResolver({ node }) {
    function resolve(_root, _args, _context, info) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const responseField = (_a = info.fieldNodes[0].selectionSet) === null || _a === void 0 ? void 0 : _a.selections.find((selection) => selection.kind === "Field" && selection.name.value === node.getPlural({ camelCase: true })); // Field exist by construction and must be selected as it is the only field.
            const responseKey = responseField.alias ? responseField.alias.value : responseField.name.value;
            return {
                info: Object.assign({ bookmark: executeResult.bookmark }, executeResult.statistics),
    ...
    return {
        ...
        resolve,
        args: Object.assign({ where: `${node.name}Where`, update: `${node.name}UpdateInput` }, (node.relationFields.length
            ? {
