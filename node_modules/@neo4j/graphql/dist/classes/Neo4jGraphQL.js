...
class Neo4jGraphQL {
    constructor(input) {
        const { config = {}, driver, resolvers, schemaDirectives } = input, schemaDefinition = __rest(input, ["config", "driver", "resolvers", "schemaDirectives"]);
    ...
    createWrappedSchema({ schema, config, }) {
        return schema_1.addSchemaLevelResolver(schema, (obj, _args, context, resolveInfo) => {
            ...
            */
            ...
            context.resolveTree = get_neo4j_resolve_tree_1.default(resolveInfo);
            if (!context.jwt) {
    ...
    checkNeo4jCompat(input = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return utils_2.checkNeo4jCompat({ driver, driverConfig });
        });
    }
}
